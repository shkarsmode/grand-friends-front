...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, Input, OnDestroy, Output, ViewChild, forwardRef } from '@angular/core';
  ...
  implements ControlValueAccessor, OnDestroy
{
  ...
  @Output() public locations: EventEmitter<IGeoLocation[]> = new EventEmitter<IGeoLocation[]>()
  ...
  public _onInputBlur(): void {
    if (!this.autocompleteLocations.find(location => location.city === this.value)) {
  ...
  public ngOnDestroy(): void {
    this.inputRef.nativeElement.removeEventListener('input', this.onChangeLocation.bind(this));
      this._destroy$.next();
